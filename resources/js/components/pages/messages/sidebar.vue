    ...
    <div class="">
        <div class="inbox_people">
          ...
          <div class="inbox_chat">
            <div class="chat_list" :class="{'active_chat':i==0}" v-for="(o,i) in contacts">
              <div class="chat_people">
                <div class="chat_img img_bubble" :style="{'background-image':'url('+o.img+')'}"> </div>
                <div class="chat_ib">
                  <h5>{{o.name}} <span class="chat_date">Dec 25</span></h5>
                  <p>{{o.text}}</p>
                </div>
              </div>
            </div>
